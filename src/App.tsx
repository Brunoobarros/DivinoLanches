      ...
      <AnimatePresence>
        {showAdminToast && latestOrderId && (
          <motion.div
            ...
            className="fixed bottom-4 right-4 z-50 bg-brand-charcoal text-white rounded-2xl p-4 shadow-2xl border border-slate-700 flex items-center gap-3.5 max-w-sm"
          >
